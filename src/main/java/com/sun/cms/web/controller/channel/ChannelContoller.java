...
public class ChannelContoller extends BaseController<Channel>{
	...
	@RequestMapping("/allsubchannels")
	@ResponseBody
	@AuthMethod
	public ModelMap allSubChannel(){
		ModelMap map = new ModelMap();
		List<Channel> subChannels = channelService.getAllSubChannels();
		map.addAttribute("allSubChannel", subChannels);
		return map;
	}
}

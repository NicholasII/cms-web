...
<body>
	...
	<div id="subcontent">
		<form id="tableform" action="/cms-web/add" method="post">
			<table>
				<tr>
				...
				<tr>
					...
					<td class="rightCol"><input type="radio" value="0" name="status"
						checked="checked">未发布<input type="radio" value="1"
						name="status">发布</td>
				</tr>
				<tr>
					<td class="leftCol">是否推荐该文章</td>
					<td class="rightCol"><input type="radio" value="0" name="recommend"
						checked="checked">不推荐<input type="radio" value="1"
						name="recommend">推荐</td>
				</tr>
				<tr>
					<td class="leftCol">发布时间</td>
					<td class="rightCol"><input type="datetime" name="createdate"></td>
				</tr>
				<tr>
